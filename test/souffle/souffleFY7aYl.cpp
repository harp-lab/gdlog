...
if (performIO) {
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","from\tto"},{"auxArity","0"},{"deliminator","\t"},{"fact-dir","."},{"filename","../../data/com-dblp.ungraph.txt"},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"from\", \"to\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
namespace  souffle {
using namespace souffle;
class Sf_souffleFY7aYl: public SouffleProgram {
public:
 Sf_souffleFY7aYl();
 ~Sf_souffleFY7aYl();
void run();
...
namespace  souffle {
using namespace souffle;
 Sf_souffleFY7aYl::Sf_souffleFY7aYl():
symTable(),
recordTable(),
regexCache(),
...
void Sf_souffleFY7aYl::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf_souffleFY7aYl::run(){
runFunction("", "", false, false);
}

void Sf_souffleFY7aYl::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf_souffleFY7aYl::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","stdoutprintsize"},{"attributeNames","from\tto"},{"auxArity","0"},{"name","path"},{"operation","printsize"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"from\", \"to\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf_souffleFY7aYl::loadAll([[maybe_unused]] std::string inputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{"IO","file"},{"attributeNames","from\tto"},{"auxArity","0"},{"deliminator","\t"},{"fact-dir","."},{"filename","../../data/com-dblp.ungraph.txt"},{"name","edge"},{"operation","input"},{"params","{\"records\": {}, \"relation\": {\"arity\": 2, \"params\": [\"from\", \"to\"]}}"},{"types","{\"ADTs\": {}, \"records\": {}, \"relation\": {\"arity\": 2, \"types\": [\"i:number\", \"i:number\"]}}"}});
...
void Sf_souffleFY7aYl::dumpInputs(){
...
void Sf_souffleFY7aYl::dumpOutputs(){
try {std::map<std::string, std::string> rwOperation;
rwOperation["IO"] = "stdout";
...
SymbolTable& Sf_souffleFY7aYl::getSymbolTable(){
return symTable;
}

RecordTable& Sf_souffleFY7aYl::getRecordTable(){
return recordTable;
}

void Sf_souffleFY7aYl::setNumThreads(std::size_t numThreadsValue){
...
void Sf_souffleFY7aYl::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
if (name == "edge") {
stratum_edge_31e40d0d94fe9f7c.run(args, ret);
return;}
if (name == "path") {
...
namespace souffle {
SouffleProgram *newInstance_souffleFY7aYl(){return new  souffle::Sf_souffleFY7aYl;}
SymbolTable *getST_souffleFY7aYl(SouffleProgram *p){return &reinterpret_cast<souffle::Sf_souffleFY7aYl*>(p)->getSymbolTable();}
} // namespace souffle
...
namespace  souffle {
using namespace souffle;
class factory_Sf_souffleFY7aYl: souffle::ProgramFactory {
public:
souffle::SouffleProgram* newInstance();
 factory_Sf_souffleFY7aYl();
private:
};
} // namespace  souffle
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf_souffleFY7aYl::newInstance(){
return new  souffle::Sf_souffleFY7aYl();
}

 factory_Sf_souffleFY7aYl::factory_Sf_souffleFY7aYl():
souffle::ProgramFactory("souffleFY7aYl"){
}
...
extern "C" {
souffle::factory_Sf_souffleFY7aYl __factory_Sf_souffleFY7aYl_instance;
}
#endif
} // namespace souffle
