...
namespace souffle {
using namespace souffle;
Stratum_edge_9543a759b165a2cb::Stratum_edge_9543a759b165a2cb(
    SymbolTable &symTable, RecordTable &recordTable,
...
void Stratum_edge_9543a759b165a2cb::run(
    ...
    if (performIO) {
        try {
            ...
            IOSystem::getInstance()
                ...
                ->readAll(*rel_edge_04d25f5060e9043b);
        } catch (std::exception &e) {
            std::cerr << "Error loading edge data: " << e.what() << '\n';
            exit(1);
        }
    }
}
...
namespace souffle {
using namespace souffle;
class Stratum_sg_d7ccf0a7e2b02c4b {
  public:
    Stratum_sg_d7ccf0a7e2b02c4b(
        SymbolTable &symTable, RecordTable &recordTable,
        ConcurrentCache<std::string, std::regex> &regexCache,
        bool &pruneImdtRels, bool &performIO, SignalHandler *&signalHandler,
        std::atomic<std::size_t> &iter, std::atomic<RamDomain> &ctr,
        std::string &inputDirectory, std::string &outputDirectory,
        t_btree_ii__0_1__11__10::Type &rel_delta_sg_15afd7e6b54494fd,
        t_btree_ii__0_1__11__10::Type &rel_new_sg_188ed73ce949edac,
        t_btree_ii__0_1__11__10::Type &rel_edge_04d25f5060e9043b,
        t_btree_ii__0_1__11::Type &rel_sg_5398a45920a7889c);
    void run([[maybe_unused]] const std::vector<RamDomain> &args,
             [[maybe_unused]] std::vector<RamDomain> &ret);
...
namespace souffle {
using namespace souffle;
Stratum_sg_d7ccf0a7e2b02c4b::Stratum_sg_d7ccf0a7e2b02c4b(
    SymbolTable &symTable, RecordTable &recordTable,
    ConcurrentCache<std::string, std::regex> &regexCache, bool &pruneImdtRels,
    bool &performIO, SignalHandler *&signalHandler,
    std::atomic<std::size_t> &iter, std::atomic<RamDomain> &ctr,
    ...
    : symTable(symTable), recordTable(recordTable), regexCache(regexCache),
      ...
      signalHandler(signalHandler), iter(iter), ctr(ctr),
      inputDirectory(inputDirectory), outputDirectory(outputDirectory),
      rel_delta_sg_15afd7e6b54494fd(&rel_delta_sg_15afd7e6b54494fd),
      rel_new_sg_188ed73ce949edac(&rel_new_sg_188ed73ce949edac),
      rel_edge_04d25f5060e9043b(&rel_edge_04d25f5060e9043b),
      rel_sg_5398a45920a7889c(&rel_sg_5398a45920a7889c) {}

void Stratum_sg_d7ccf0a7e2b02c4b::run(
    [[maybe_unused]] const std::vector<RamDomain> &args,
    [[maybe_unused]] std::vector<RamDomain> &ret) {
    signalHandler->setMsg(R"_(sg(x,y) :- 
   edge(p,x),
   edge(p,y),
   x != y.
in file sg.dl [7:1-7:44])_");
    if (!(rel_edge_04d25f5060e9043b->empty())) {
        [&]() {
            auto part = rel_edge_04d25f5060e9043b->partition();
            PARALLEL_START
            CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,
                              rel_edge_04d25f5060e9043b->createContext());
            CREATE_OP_CONTEXT(rel_sg_5398a45920a7889c_op_ctxt,
                              rel_sg_5398a45920a7889c->createContext());
            ...
            pfor(auto it = part.begin(); it < part.end(); it++) {
                ...
                try {
                    for (const auto &env0 : *it) {
                        auto range =
                            rel_edge_04d25f5060e9043b->lowerUpperRange_10(
                                Tuple<RamDomain, 2>{
                                    {ramBitCast(env0[0]),
                                ...
                                READ_OP_CONTEXT(
                                    rel_edge_04d25f5060e9043b_op_ctxt));
                        for (const auto &env1 : range) {
                            if ((ramBitCast<RamDomain>(env0[1]) !=
                                 ramBitCast<RamDomain>(env1[1]))) {
                                Tuple<RamDomain, 2> tuple{
                                    {ramBitCast(env0[1]), ramBitCast(env1[1])}};
                                rel_sg_5398a45920a7889c->insert(
                                    tuple,
                                    READ_OP_CONTEXT(
                                        rel_sg_5398a45920a7889c_op_ctxt));
                            }
                        }
                    }
                } catch (std::exception &e) {
                    signalHandler->error(e.what());
                }
            }
            PARALLEL_END
        }();
    ...
    [&]() {
        CREATE_OP_CONTEXT(rel_delta_sg_15afd7e6b54494fd_op_ctxt,
                          rel_delta_sg_15afd7e6b54494fd->createContext());
        CREATE_OP_CONTEXT(rel_sg_5398a45920a7889c_op_ctxt,
                          rel_sg_5398a45920a7889c->createContext());
        for (const auto &env0 : *rel_sg_5398a45920a7889c) {
            Tuple<RamDomain, 2> tuple{
                {ramBitCast(env0[0]), ramBitCast(env0[1])}};
            rel_delta_sg_15afd7e6b54494fd->insert(
                tuple, READ_OP_CONTEXT(rel_delta_sg_15afd7e6b54494fd_op_ctxt));
        }
    }();
   ...
   sg(a,b),
   edge(b,y).
in file sg.dl [8:1-8:46])_");
        if (!(rel_edge_04d25f5060e9043b->empty()) &&
            !(rel_delta_sg_15afd7e6b54494fd->empty())) {
            [&]() {
                auto part = rel_edge_04d25f5060e9043b->partition();
                PARALLEL_START
                CREATE_OP_CONTEXT(
                    rel_delta_sg_15afd7e6b54494fd_op_ctxt,
                    rel_delta_sg_15afd7e6b54494fd->createContext());
                CREATE_OP_CONTEXT(rel_new_sg_188ed73ce949edac_op_ctxt,
                                  rel_new_sg_188ed73ce949edac->createContext());
                CREATE_OP_CONTEXT(rel_edge_04d25f5060e9043b_op_ctxt,
                                  rel_edge_04d25f5060e9043b->createContext());
                CREATE_OP_CONTEXT(rel_sg_5398a45920a7889c_op_ctxt,
                                  rel_sg_5398a45920a7889c->createContext());
                ...
                pfor(auto it = part.begin(); it < part.end(); it++) {
                    ...
                    try {
                        for (const auto &env0 : *it) {
                            auto range =
                                rel_delta_sg_15afd7e6b54494fd->lowerUpperRange_10(
                            ...
                            for (const auto &env1 : range) {
                                ...
                                for (const auto &env2 : range) {
                                    if (!(rel_sg_5398a45920a7889c->contains(
                                            Tuple<RamDomain, 2>{
                                                {ramBitCast(env0[1]),
                                                 ramBitCast(env2[1])}},
                                            READ_OP_CONTEXT(
                                        ...
                                        Tuple<RamDomain, 2> tuple{
                                            {ramBitCast(env0[1]),
                                             ramBitCast(env2[1])}};
                                        rel_new_sg_188ed73ce949edac->insert(
                                            tuple,
                                            READ_OP_CONTEXT(
                                                rel_new_sg_188ed73ce949edac_op_ctxt));
                                    }
                                }
                            }
                        }
        ...
        if (rel_new_sg_188ed73ce949edac->empty())
            break;
        [&]() {
            CREATE_OP_CONTEXT(rel_new_sg_188ed73ce949edac_op_ctxt,
                              rel_new_sg_188ed73ce949edac->createContext());
            CREATE_OP_CONTEXT(rel_sg_5398a45920a7889c_op_ctxt,
                              rel_sg_5398a45920a7889c->createContext());
            for (const auto &env0 : *rel_new_sg_188ed73ce949edac) {
                Tuple<RamDomain, 2> tuple{
                    {ramBitCast(env0[0]), ramBitCast(env0[1])}};
                rel_sg_5398a45920a7889c->insert(
                    tuple, READ_OP_CONTEXT(rel_sg_5398a45920a7889c_op_ctxt));
            }
        }();
        std::swap(rel_delta_sg_15afd7e6b54494fd, rel_new_sg_188ed73ce949edac);
        rel_new_sg_188ed73ce949edac->purge();
        loop_counter = (ramBitCast<RamUnsigned>(loop_counter) +
                        ramBitCast<RamUnsigned>(RamUnsigned(1)));
        iter++;
    }
    iter = 0;
    rel_delta_sg_15afd7e6b54494fd->purge();
    rel_new_sg_188ed73ce949edac->purge();
    if (performIO) {
        try {
            std::map<std::string, std::string> directiveMap(
            ...
            IOSystem::getInstance()
                ...
                ->writeAll(*rel_sg_5398a45920a7889c);
        } catch (std::exception &e) {
            std::cerr << e.what();
            exit(1);
        }
    ...
    if (pruneImdtRels)
        rel_edge_04d25f5060e9043b->purge();
}
...
class Sf_sg : public SouffleProgram {
  ...
  private:
    ...
    souffle::RelationWrapper<t_btree_ii__0_1__11__10::Type>
        wrapper_rel_edge_04d25f5060e9043b;
    Own<t_btree_ii__0_1__11::Type> rel_sg_5398a45920a7889c;
    souffle::RelationWrapper<t_btree_ii__0_1__11::Type>
        wrapper_rel_sg_5398a45920a7889c;
    Own<t_btree_ii__0_1__11__10::Type> rel_delta_sg_15afd7e6b54494fd;
    Own<t_btree_ii__0_1__11__10::Type> rel_new_sg_188ed73ce949edac;
    Stratum_edge_9543a759b165a2cb stratum_edge_31e40d0d94fe9f7c;
    Stratum_sg_d7ccf0a7e2b02c4b stratum_sg_9f4b41dccae842af;
    std::string inputDirectory;
    std::string outputDirectory;
...
Sf_sg::Sf_sg()
    : symTable(), recordTable(), regexCache(),
      ...
      wrapper_rel_edge_04d25f5060e9043b(
          0, *rel_edge_04d25f5060e9043b, *this, "edge",
          std::array<const char *, 2>{{"i:number", "i:number"}},
          std::array<const char *, 2>{{"x", "y"}}, 0),
      rel_sg_5398a45920a7889c(mk<t_btree_ii__0_1__11::Type>()),
      wrapper_rel_sg_5398a45920a7889c(
          1, *rel_sg_5398a45920a7889c, *this, "sg",
          std::array<const char *, 2>{{"i:number", "i:number"}},
          std::array<const char *, 2>{{"x", "y"}}, 0),
      rel_delta_sg_15afd7e6b54494fd(mk<t_btree_ii__0_1__11__10::Type>()),
      rel_new_sg_188ed73ce949edac(mk<t_btree_ii__0_1__11__10::Type>()),
      stratum_edge_31e40d0d94fe9f7c(symTable, recordTable, regexCache,
                                    pruneImdtRels, performIO, signalHandler,
                                    iter, ctr, inputDirectory, outputDirectory,
                                    *rel_edge_04d25f5060e9043b),
      stratum_sg_9f4b41dccae842af(
          symTable, recordTable, regexCache, pruneImdtRels, performIO,
          signalHandler, iter, ctr, inputDirectory, outputDirectory,
          *rel_delta_sg_15afd7e6b54494fd, *rel_new_sg_188ed73ce949edac,
          *rel_edge_04d25f5060e9043b, *rel_sg_5398a45920a7889c) {
    addRelation("edge", wrapper_rel_edge_04d25f5060e9043b, true, false);
    addRelation("sg", wrapper_rel_sg_5398a45920a7889c, false, true);
}

Sf_sg::~Sf_sg() {}

void Sf_sg::runFunction(std::string inputDirectoryArg,
                        std::string outputDirectoryArg, bool performIOArg,
                        bool pruneImdtRelsArg) {
    ...
    {
        std::vector<RamDomain> args, ret;
        stratum_sg_9f4b41dccae842af.run(args, ret);
    }
...
void Sf_sg::run() { runFunction("", "", false, false); }

void Sf_sg::runAll(std::string inputDirectoryArg,
                   std::string outputDirectoryArg, bool performIOArg,
                   bool pruneImdtRelsArg) {
...
void Sf_sg::dumpInputs() {
    try {
        ...
        IOSystem::getInstance()
            ...
            ->writeAll(*rel_edge_04d25f5060e9043b);
    } catch (std::exception &e) {
        std::cerr << e.what();
        exit(1);
    }
...
SymbolTable &Sf_sg::getSymbolTable() { return symTable; }

RecordTable &Sf_sg::getRecordTable() { return recordTable; }
...
void Sf_sg::executeSubroutine(std::string name,
...
namespace souffle {
SouffleProgram *newInstance_sg() { return new souffle::Sf_sg; }
SymbolTable *getST_sg(SouffleProgram *p) {
    return &reinterpret_cast<souffle::Sf_sg *>(p)->getSymbolTable();
}
} // namespace souffle
...
int main(int argc, char **argv) {
    try {
        souffle::CmdOptions opt(R"(./sg.dl)", R"()", R"()", false, R"()", 8);
...
namespace souffle {
using namespace souffle;
souffle::SouffleProgram *factory_Sf_sg::newInstance() {
    return new souffle::Sf_sg();
}

factory_Sf_sg::factory_Sf_sg() : souffle::ProgramFactory("sg") {}
...
extern "C" {
souffle::factory_Sf_sg __factory_Sf_sg_instance;
}
#endif
} // namespace souffle
